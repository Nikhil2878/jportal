...
const ApplicantSettingsForm = ({ initialData }: ApplicantSettingsFormProps) => {
  ...
  const isUpdating = !!initialData?.location;//Boolean coersion
                    ...
                    render={({ field, fieldState }) => (
                      <div>
                        ...
                        <ImageUpload
                          ...
                          className={cn(
                            "h-32 w-32",
                            fieldState.error && "ring-1 ring-destructive/50 focus-visible:ring-destructive",
                          )}
                        />
                        {fieldState.error && (
