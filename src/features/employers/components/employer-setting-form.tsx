...
import { Briefcase, Building2, Calendar, FileText, Globe, Loader, Loader2, Mail, MapPin, Upload, Users, X } from "lucide-react";
...
const EmployerSettingsForm = ({
  ...
  initialData?: Partial<EmployerProfileData>; // Key: Type
   ...
   const {
    ...
    setValue("bannerImageUrl", ""); //Programmatically update a form field’s value inside react-hook-form.
  };
